...
Figma, Adobe XD, Photoshop, Illustrator, UX Design, Jest (Test-driven Development), Unit Testing, React, Redux

Coming soon:
Router, Typescript

Would like to learn:
Next.js, Vue.js, Vite, Nuxt, React query, Svelte, Three.js, Machine Learning, Python, Tauri, RedwoodJS
